...
LIB_Z_SCORE = pd.read_csv(os.path.join(lab_binding_path, 'ChEC_lib_zscore.csv'))
...
Msn2_mer5_binding = pd.read_csv(os.path.join(lab_binding_path, 'Msn2_mer5_signal.csv'))
...
rossi_lib_z = pd.read_csv(os.path.join(external_data_path, 'Rossie_lib_zscore.csv'))
